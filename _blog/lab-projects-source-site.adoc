...
:page-metablog: true
:page-redirect_from: /metablog/lab-projects-source-site/
:page-tags: ["Jekyll", "YAML", "Liquid", "single-sourcing", "metadata"]
:page-date: 2025-09-25
:page-author: Dr Meta
:page-published: true
...
The link:{docopslab_src_www_url}/blob/main/_data/docops-lab-projects.yml[`docops-lab-projects.yml` file] is basically a large array of tabular data.

...
Here I include a window into the current state of one such document (link:https://github.com/DocOps/lab/blob/agent-docs/skills/git.md[source], link:{docopslab_www_url}/docs/agent/git[rendered]), which may change over time as I refine the AI-agent docs:

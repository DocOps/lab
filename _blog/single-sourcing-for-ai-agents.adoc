...
:page-tags: ["AI", "single-sourcing", "AsciiDoc", "Markdown"]
...
My extension is available as link:{this_proj_src_www_url}/blob/main/scripts/mark_down_grade.rb[`scripts/mark_down_grade.rb`] in this very repo.

Here I include a window into the current state of one such document (link:https://github.com/DocOps/lab/blob/agent-docs/skills/git.md[source], link:{docopslab_src_www_url}/docs/agent/git[rendered]), which may change over time as I refine the AI-agent docs:

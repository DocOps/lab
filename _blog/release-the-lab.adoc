...
The site is heavily data driven, mainly based on a complex link:{this_proj_src_www_url}/blob/main/_data/docops-lab-projects.yml[YAML file] maintained for the past 2+ years to track projects, their relationships, progress, and so forth.

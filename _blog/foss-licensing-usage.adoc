...
CC BY indicates a requirement to note what changes are made if you redistribute the so-licensed content, so for stuff like Docs-as-Code School or link:{docopslab_www_base_url}[the main (this) DocOpsLab.org] website.

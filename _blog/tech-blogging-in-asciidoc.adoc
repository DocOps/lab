...
:example-caption!:
:page-github-url: {docopslab_src_www_url}/blob/main/_metablog/tech-blogging-in-asciidoc.adoc
:page-github-edit-url: {docopslab_src_www_url}/edit/main/_metablog/tech-blogging-in-asciidoc.adoc
...
Styling and effects are outside this post, but you can find the sources for all of this at {this_proj_src_www_url}/tree/main/_sass/asciidoc.scss and {this_proj_src_www_url}/tree/main/assets/js/main.js.

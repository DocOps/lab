...
Git commit message checking for local hooks and CI.
...
`git-lint` 6.x expects an XDG config path named `git-lint/configuration.yml`.
...
CI should use `labdev:lint:commits` on feature branches or pull request heads.

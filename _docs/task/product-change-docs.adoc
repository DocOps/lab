...
[TIP]
For a structured agentic procedure to assess which documentation files are affected by a code change, see {xref_docs_agent_skills_assess-documentation-impact_link}.

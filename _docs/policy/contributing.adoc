...
The latest {xref_projects_box_link} to create a base image that should suffice for developing any DocOps Lab codebase.
...
[TIP]
====
When your changes affect code that is documented elsewhere in the repository, follow {xref_docs_agent_skills_assess-documentation-impact_link} to identify and update all related documentation.
This ensures documentation stays accurate and complete.
====

...
[NOTE]
Some Dockerfiles combine multiple applications, such as the link:{docopslab_src_www_url}[issuer-rhx image], which combines both the Issuer and ReleaseHx applications.

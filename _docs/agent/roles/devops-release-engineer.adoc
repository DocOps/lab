...
. Consider communicating infrastructure and ops updates upstream to the org level (see <<upstreaming>>).
...
. Record any deviations from the plan and consider communicating them upstream to the org level (see <<upstreaming>>).
